...
public class MathUtils {
    /**
     * Получить ближайшее от заданного округленное (вверх или вниз) двоичное значение.
    ...
    /**
     * Проверить является ли заданное значение простым числом.
    ...
    /**
     * Получить простое число на основе заданного значения с округлением вверх.
     * @param value заданное целочисленное число.
    ...
    /**
     * Получить количество уровней полного дерева.
